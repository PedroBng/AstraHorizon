...
const cards = document.querySelectorAll(".btn-1");
...
const fm = document.getElementById("open");
const fb = document.getElementById("pc1");
const fn = document.getElementById("close");

if (fm) {
    fm.addEventListener('click', () => {
        fb.classList.add('actives');

    })
}
if (fn) {
    fn.addEventListener('click', () => {
        fb.classList.remove('actives');
    })
}